...
if (isset($_POST['submit_movie'])) {
  ...
  $count = mysqli_query($db, "SELECT movie_id FROM movies");
  $count = mysqli_num_rows($count);
  $count += 1;

  $for_query = substr($for_query, 0, -1);
  $sql = "INSERT INTO movies VALUES ('$count', '$poster', '$title', '$synopsis', '$duration', '$for_query', '$date')";
  mysqli_query($db, $sql);
...
<head>
  <title>U-CINEMA : Add-Movie</title>
  ...
  <div class="container" style="padding: 30px;">
    <div class="card d-flex justify-content-center shadow p-3 mb-5 bg-white rounded" style="width: 40%;margin-left: 30%;">
      <form action='' method="POST" style="padding: 20px;" enctype="multipart/form-data">
        ...
        <h1 class="d-flex justify-content-center">Add Movie</h1><br>
        ...
        <div class="d-flex justify-content-center">
          <button type="submit" class="btn btn-warning" style="padding-left: 10%;padding-right: 10%;font-size: 130%;" name="submit_movie">Add</button>
        </div>
      </form>
    </div>
  </div>
